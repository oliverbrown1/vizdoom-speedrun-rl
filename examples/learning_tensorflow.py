...
class DQNAgent:
    def __init__(
        self, num_actions=32, epsilon=1, epsilon_min=0.1, epsilon_decay=0.9995, load=load
    ):
    ...
    def train_dqn(self, samples):
        ...
        with tf.GradientTape() as tape:
            trainable_vars = [tf.convert_to_tensor(var) if not isinstance(var, tf.Variable) else var 
